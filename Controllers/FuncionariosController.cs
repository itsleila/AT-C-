...
namespace InfnetMVC.Controllers
{
    ...
    public class FuncionariosController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["DepartamentoId"] = new SelectList(departamentos, "DepartamentoId", "Nome");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Endereco,Telefone,Email,DataNascimento,DepartamentoId")] Funcionario funcionario)
        {
            ...
            var departamentos = _context.Departamento.ToList();
            ViewData["DepartamentoId"] = new SelectList(departamentos, "DepartamentoId", "Nome", funcionario.DepartamentoId);
            return View(funcionario);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Endereco,Telefone,Email,DataNascimento,DepartamentoId")] Funcionario funcionario)
        {
